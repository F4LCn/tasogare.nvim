...
function M.invert(color)
  ...
  elseif type(color) == "string" then
    local hsluv = require("tasogare.hsluv")
    if color ~= "NONE" then
...
---@param groups tasogare.Highlights
...
function M.cache.file(key)
  return vim.fn.stdpath("cache") .. "/tasogare-" .. key .. ".json"
end

---@param key string
function M.cache.read(key)
  ---@type boolean, tasogare.Cache
